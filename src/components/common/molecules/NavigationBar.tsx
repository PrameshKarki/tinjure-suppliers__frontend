      ...
      <Flex alignItems={'center'}>
        ...
        <Box className='flex items-center'>
          <InputGroup width={500}>
            <Input placeholder='Search Product' size='md' onKeyPress={handleKeyPress} />
          ...
          <Menu>
            <MenuButton as={Button} rounded={'full'} variant={'link'} cursor={'pointer'} minW={0} ml={10} zIndex={100}>
