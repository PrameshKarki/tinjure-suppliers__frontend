...
const Cookie = () => {
  ...
  const handleCookies = async () => {
    setCookies(true)
    // store cookies value in cookies
    Cookies.set('myCookie', values, { expires: 7 }) // Store the value in a cookie for 7 days
  }
  return (
    <>
      {!cookies && (
        <section className='z-[100] fixed max-w-md p-4 mx-auto bg-white border border-gray-200 dark:bg-gray-800 left-12 bottom-16 dark:border-gray-700 rounded-2xl'>
